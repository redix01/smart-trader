...
<link href="css/main7980.css?r=154" rel="stylesheet"/>
<link href="css/tw6234.css?r=747" rel="stylesheet"/>
...
<div class="account-sidebar udex-collapse shadow-lg p-0" id="mySidebar">
  <div class="account-header px-3 py-3">
      ...
      <img src="images/logoc549.png?r=926" class='wow slideInLeft' title="Cognizant ProMarket" style="height: 55px; filter: invert(95%)"/>
    </a>
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark text-light py-0">
    ...
    <a class="navbar-brand mr-3 p-0 wow slideInLeft" href="{{ url("/") }}">
      <img src="images/logoe2d0.png?r=612" title="Cognizant ProMarket" style="height: 55px;filter: invert(95%)"/>
    </a>
...
<div class="container py-5 text-container">
		<h1>FAQs</h1>
		<p class="pb-5">Everything you need to know about our platform. Can’t find the answer you’re looking for? Please chat to our team.</p>
		<div class="row">
			<div class="col-md-4 py-3">
						<h3>What is cryptocurrency ?</h3>
						<p>Cryptocurrency is any form of currency that exists digitally or virtually and uses cryptography to secure transactions. Cryptocurrencies don't have a central issuing or regulating authority, instead using a decentralized system to record transactions and issue new units.</p>
						...
						<h3>Is Crypto  Used For Illegal Activities?</h3>
						<p>This is a yet another controversial topic. Because of the freedom and the degree of anonymity that the use of Crypto offers, many users who were seeking to purchase or solicit illegal goods or services initially turned to the use of Crypto  as a method of payment.</p>
					</div><div class="col-md-4 py-3">
