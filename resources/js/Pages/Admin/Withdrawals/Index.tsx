          ...
          <tbody className="divide-y divide-[#0A0A0A]">
            {withdrawals.data.map(w => (
              <tr key={w.id} className="hover:bg-[#151515] transition-colors">
                ...
                <td className="px-6 py-4 text-right"><Link href={route('admin.withdrawals.show', w.id)} className="text-xs font-bold text-blue-500 hover:text-blue-400">View</Link></td>
              </tr>
            ))}
          </tbody>
        </table>
